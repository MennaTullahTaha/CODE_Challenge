class OrphanagesController < ApplicationController
	...
	def create
		...
		if @orphanage.save
			...
			flash[:notice] = "You have signed up successfully, wait for admin approval before you can use the website functionality!"
	...
	def index
		@orphanages = Orphanage.where(verified: true).paginate(page: params[:page], per_page: 5)
	end
